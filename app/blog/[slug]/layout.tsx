...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'tabukharaj online','tabuk haraj online','tabukharaj shop online','shop tabukharaj',
    'tabuk used furniture buy',
    'tabuk used furniture sell',
    'tabuk used electronics buy',
    'tabuk used electronics sell',
    'used electronics marketplace Saudi Arabia',
    'used furniture marketplace Saudi Arabia',
    'buy used electronics Saudi Arabia',
